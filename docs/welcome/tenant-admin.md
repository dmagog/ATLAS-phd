...
После входа главная страница — **программа кафедры** с обзором coverage по каждому билету, активных инвайтов и пользователей:

![tenant-admin](../design/screenshots/after/07-tenant-admin.png)

Управление инвайтами — на отдельной странице `/_/invites` (sidebar → «Инвайты»), там полный список с copy-кнопкой для каждого кода:

![invites-page](../design/screenshots/after/10-invites-page.png)
